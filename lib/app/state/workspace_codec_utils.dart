...
const String defaultStyleBindingFeedback = '反馈会说明当前绑定范围、已同步的规则集和强度建议。';
const String defaultAuditActionFeedback = '等待处理';
...
// ============================================================================
// Style Validation & Build Functions
// ============================================================================
...
List<String> styleWarningMessages(Map<String, Object?> draft) {
...
StyleValidationResult validateStyleProfileJson(Map<String, Object?> jsonData) {
  ...
  final warnings = styleWarningMessages(styleDraftFromProfileJson(profileJson));
...
ProjectStyleState defaultStyleState() {
  ...
  return ProjectStyleState(
    ...
    warningMessages: styleWarningMessages(defaultStyleQuestionnaireDraft),
  );
}
...
void saveStyleProfile({
  ...
  styleByProjectId[projectId] = currentStyle.copyWith(
    ...
    warningMessages: warningMessages ?? styleWarningMessages(profile.jsonData),
  );
}
