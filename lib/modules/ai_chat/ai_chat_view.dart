            ...
            child: Obx(() {
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final isSelected =
                      logic.state.currentConversation.value?.id == conv.id;
          ...
          child: Row(
            children: [
              ...
              Expanded(
                child: Obx(() {
                  final title =
                      logic.state.currentConversation.value?.title ?? 'AI 助手';
                  return Text(
                    title,
          ...
          child: Obx(() {
            ...
            return ListView.builder(
              ...
              itemCount: messages.length +
                  (logic.state.toolStatus.value != null ||
                          logic.state.toolResults.isNotEmpty
                      ? 1
                      : 0) +
              ...
              itemBuilder: (context, index) {
                ...
                if ((toolStatus != null || toolResults.isNotEmpty) &&
                    extraIndex == 0) {
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          SizedBox(width: 8.w),
          Obx(() {
            final isGenerating = widget.logic.state.isGenerating.value;
