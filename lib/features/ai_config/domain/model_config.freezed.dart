...
class _$ModelConfigImpl implements _ModelConfig {
  ...
  @override
  String toString() {
    return 'ModelConfig(tier: $tier, providerType: $providerType, modelName: $modelName, apiEndpoint: $apiEndpoint, temperature: $temperature, maxOutputTokens: $maxOutputTokens, topP: $topP, frequencyPenalty: $frequencyPenalty, presencePenalty: $presencePenalty, isEnabled: $isEnabled, lastValidatedAt: $lastValidatedAt, isValid: $isValid)';
  }
...
mixin _$FunctionMapping {
  String get functionKey => throw _privateConstructorUsedError;
...
class _$FunctionMappingImpl extends _FunctionMapping {
  ...
  @override
  String toString() {
    return 'FunctionMapping(functionKey: $functionKey, overrideTierName: $overrideTierName, useOverride: $useOverride)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.overrideTierName, overrideTierName) ||
                other.overrideTierName == overrideTierName) &&
