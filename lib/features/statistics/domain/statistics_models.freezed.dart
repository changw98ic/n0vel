...
abstract class $WorkStatisticsCopyWith<$Res> {
  factory $WorkStatisticsCopyWith(
          WorkStatistics value, $Res Function(WorkStatistics) then) =
...
abstract class _$$WorkStatisticsImplCopyWith<$Res>
    implements $WorkStatisticsCopyWith<$Res> {
  factory _$$WorkStatisticsImplCopyWith(_$WorkStatisticsImpl value,
...
class __$$WorkStatisticsImplCopyWithImpl<$Res>
  ...
  __$$WorkStatisticsImplCopyWithImpl(
      _$WorkStatisticsImpl _value, $Res Function(_$WorkStatisticsImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$WorkStatisticsImpl(
      workId: null == workId
          ? _value.workId
          : workId // ignore: cast_nullable_to_non_nullable
              as String,
...
// 近期活动
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.averageDailyWritingMinutes,
            ...
            const DeepCollectionEquality()
                .equals(other._recentWordCounts, _recentWordCounts) &&
            const DeepCollectionEquality()
  ...
  Map<String, dynamic> toJson() {
    return _$$WorkStatisticsImplToJson(
      this,
    );
  }
}
...
abstract class _WorkStatistics implements WorkStatistics {
  ...
  @override
  double get averageChapterWords;
  @override // 时间统计
  int get writingDays;
  @override
...
abstract class $DailyWordCountCopyWith<$Res> {
  factory $DailyWordCountCopyWith(
          DailyWordCount value, $Res Function(DailyWordCount) then) =
      _$DailyWordCountCopyWithImpl<$Res, DailyWordCount>;
  @useResult
  $Res call(
      {DateTime date, int wordCount, int chapterCount, int writingMinutes});
}
...
abstract class _$$DailyWordCountImplCopyWith<$Res>
    implements $DailyWordCountCopyWith<$Res> {
  factory _$$DailyWordCountImplCopyWith(_$DailyWordCountImpl value,
...
class __$$DailyWordCountImplCopyWithImpl<$Res>
  ...
  __$$DailyWordCountImplCopyWithImpl(
      _$DailyWordCountImpl _value, $Res Function(_$DailyWordCountImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$DailyWordCountImpl(
      date: null == date
          ? _value.date
          : date // ignore: cast_nullable_to_non_nullable
              as DateTime,
...
class _$DailyWordCountImpl implements _DailyWordCount {
  ...
  @override
  Map<String, dynamic> toJson() {
    return _$$DailyWordCountImplToJson(
      this,
    );
  }
}
...
abstract class _DailyWordCount implements DailyWordCount {
  const factory _DailyWordCount(
      ...
      required final int writingMinutes}) = _$DailyWordCountImpl;
...
class _$ChapterProgressImpl implements _ChapterProgress {
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, chapterId, chapterTitle, order,
      wordCount, status, updatedAt, reviewScore);
...
abstract class _ChapterProgress implements ChapterProgress {
  const factory _ChapterProgress(
      ...
      required final DateTime updatedAt,
      required final double? reviewScore}) = _$ChapterProgressImpl;
...
abstract class $WritingSessionStatsCopyWith<$Res> {
  factory $WritingSessionStatsCopyWith(
          WritingSessionStats value, $Res Function(WritingSessionStats) then) =
...
abstract class _$$WritingSessionStatsImplCopyWith<$Res>
    implements $WritingSessionStatsCopyWith<$Res> {
  factory _$$WritingSessionStatsImplCopyWith(_$WritingSessionStatsImpl value,
...
class __$$WritingSessionStatsImplCopyWithImpl<$Res>
  ...
  __$$WritingSessionStatsImplCopyWithImpl(_$WritingSessionStatsImpl _value,
  ...
  $Res call({
    ...
    return _then(_$WritingSessionStatsImpl(
      date: null == date
          ? _value.date
          : date // ignore: cast_nullable_to_non_nullable
              as DateTime,
...
class _$WritingSessionStatsImpl implements _WritingSessionStats {
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, date, totalMinutes, totalWords,
      sessionCount, const DeepCollectionEquality().hash(_hourlyDistribution));
  ...
  @override
  Map<String, dynamic> toJson() {
    return _$$WritingSessionStatsImplToJson(
      this,
    );
  }
}
...
abstract class $WordCountTrendCopyWith<$Res> {
  factory $WordCountTrendCopyWith(
          WordCountTrend value, $Res Function(WordCountTrend) then) =
...
abstract class _$$WordCountTrendImplCopyWith<$Res>
    implements $WordCountTrendCopyWith<$Res> {
  factory _$$WordCountTrendImplCopyWith(_$WordCountTrendImpl value,
...
class __$$WordCountTrendImplCopyWithImpl<$Res>
  ...
  __$$WordCountTrendImplCopyWithImpl(
      _$WordCountTrendImpl _value, $Res Function(_$WordCountTrendImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$WordCountTrendImpl(
      period: null == period
          ? _value.period
          : period // ignore: cast_nullable_to_non_nullable
              as TrendPeriod,
...
class _$WordCountTrendImpl implements _WordCountTrend {
  ...
  @override
  Map<String, dynamic> toJson() {
    return _$$WordCountTrendImplToJson(
      this,
    );
  }
}
...
abstract class _WordCountTrend implements WordCountTrend {
  const factory _WordCountTrend(
      ...
      required final int totalGrowth}) = _$WordCountTrendImpl;
...
class _$TrendDataPointImpl implements _TrendDataPoint {
  const _$TrendDataPointImpl(
      {required this.date, required this.value, required this.cumulativeValue});
...
abstract class _TrendDataPoint implements TrendDataPoint {
  const factory _TrendDataPoint(
      ...
      required final int cumulativeValue}) = _$TrendDataPointImpl;
...
abstract class $CharacterAppearanceStatsCopyWith<$Res> {
  factory $CharacterAppearanceStatsCopyWith(CharacterAppearanceStats value,
...
/// @nodoc
class _$CharacterAppearanceStatsCopyWithImpl<$Res,
...
class __$$CharacterAppearanceStatsImplCopyWithImpl<$Res>
    extends _$CharacterAppearanceStatsCopyWithImpl<$Res,
  ...
  $Res call({
    ...
    return _then(_$CharacterAppearanceStatsImpl(
      characterId: null == characterId
          ? _value.characterId
          : characterId // ignore: cast_nullable_to_non_nullable
              as String,
...
class _$CharacterAppearanceStatsImpl implements _CharacterAppearanceStats {
  ...
  _$$CharacterAppearanceStatsImplCopyWith<_$CharacterAppearanceStatsImpl>
      get copyWith => __$$CharacterAppearanceStatsImplCopyWithImpl<
          _$CharacterAppearanceStatsImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$CharacterAppearanceStatsImplToJson(
      this,
    );
  }
}
...
abstract class $WritingGoalCopyWith<$Res> {
  factory $WritingGoalCopyWith(
          WritingGoal value, $Res Function(WritingGoal) then) =
...
abstract class _$$WritingGoalImplCopyWith<$Res>
  ...
  factory _$$WritingGoalImplCopyWith(
          _$WritingGoalImpl value, $Res Function(_$WritingGoalImpl) then) =
...
class __$$WritingGoalImplCopyWithImpl<$Res>
  ...
  __$$WritingGoalImplCopyWithImpl(
      _$WritingGoalImpl _value, $Res Function(_$WritingGoalImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$WritingGoalImpl(
      id: null == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as String,
...
class _$WritingGoalImpl implements _WritingGoal {
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, workId, type, targetValue,
      currentValue, startDate, endDate, isCompleted, createdAt);
  ...
  @override
  Map<String, dynamic> toJson() {
    return _$$WritingGoalImplToJson(
      this,
    );
  }
}
...
abstract class _WritingGoal implements WritingGoal {
  const factory _WritingGoal(
      ...
      required final DateTime createdAt}) = _$WritingGoalImpl;
...
abstract class $WritingReportCopyWith<$Res> {
  factory $WritingReportCopyWith(
          WritingReport value, $Res Function(WritingReport) then) =
...
abstract class _$$WritingReportImplCopyWith<$Res>
  ...
  factory _$$WritingReportImplCopyWith(
          _$WritingReportImpl value, $Res Function(_$WritingReportImpl) then) =
...
class __$$WritingReportImplCopyWithImpl<$Res>
  ...
  __$$WritingReportImplCopyWithImpl(
      _$WritingReportImpl _value, $Res Function(_$WritingReportImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$WritingReportImpl(
      id: null == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as String,
...
class _$WritingReportImpl implements _WritingReport {
  ...
  @override
  Map<String, dynamic> toJson() {
    return _$$WritingReportImplToJson(
      this,
    );
  }
}
...
abstract class _WritingReport implements WritingReport {
  const factory _WritingReport(
      ...
      required final List<DailyWordCount> dailyBreakdown,
      required final Map<String, dynamic> insights,
      required final DateTime generatedAt}) = _$WritingReportImpl;
...
abstract class $StatisticsExportOptionsCopyWith<$Res> {
  factory $StatisticsExportOptionsCopyWith(StatisticsExportOptions value,
...
/// @nodoc
class _$StatisticsExportOptionsCopyWithImpl<$Res,
...
class __$$StatisticsExportOptionsImplCopyWithImpl<$Res>
    extends _$StatisticsExportOptionsCopyWithImpl<$Res,
  ...
  $Res call({
    ...
    return _then(_$StatisticsExportOptionsImpl(
      format: null == format
          ? _value.format
          : format // ignore: cast_nullable_to_non_nullable
              as StatisticsExportFormat,
...
class _$StatisticsExportOptionsImpl implements _StatisticsExportOptions {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.includeCharacterAppearances,
  ...
  _$$StatisticsExportOptionsImplCopyWith<_$StatisticsExportOptionsImpl>
      get copyWith => __$$StatisticsExportOptionsImplCopyWithImpl<
          _$StatisticsExportOptionsImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$StatisticsExportOptionsImplToJson(
      this,
    );
  }
}
...
abstract class _StatisticsExportOptions implements StatisticsExportOptions {
  const factory _StatisticsExportOptions(
      ...
      final DateTime? startDate,
      final DateTime? endDate,
      final int? days}) = _$StatisticsExportOptionsImpl;
